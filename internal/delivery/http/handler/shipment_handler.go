...
//	}
//
//	result, err := h.service.CompleteDelivery(c.Request.Context(), shipmentID, &req)
//	if err != nil {
//		utils.ErrorResponse(c, http.StatusBadRequest, err.Error())
//		return
//	}
...
//	}
//
//	result, err := h.service.ReportIssue(c.Request.Context(), shipmentID, &req)
//	if err != nil {
//		utils.ErrorResponse(c, http.StatusBadRequest, err.Error())
//		return
//	}
...
//	}
//
//	result, err := h.service.CancelShipment(c.Request.Context(), shipmentID, &req)
//	if err != nil {
//		utils.ErrorResponse(c, http.StatusBadRequest, err.Error())
//		return
//	}
...
//	}
//
//	result, err := h.service.GetShipment(c.Request.Context(), shipmentID)
//	if err != nil {
...
//	}
//
//	result, err := h.service.ListShipments(c.Request.Context(), &filter)
//	if err != nil {
