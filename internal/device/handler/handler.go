...
import (
	...
	"logistics-quality-monitor/internal/device/service"
...
func NewHandler(service *service.DeviceService) *DeviceHandler {
...
func (h *DeviceHandler) CreateDevice(c *gin.Context) {
	...
	device, err := h.service.CreateDevice(c.Request.Context(), &request)
	if err != nil {
...
func (h *DeviceHandler) ListDevices(c *gin.Context) {
	var filter model.DeviceFilterRequest
...
func (h *DeviceHandler) UpdateDevice(c *gin.Context) {
	...
	var request model.UpdateDeviceRequest
	if err := c.ShouldBindJSON(&request); err != nil {
		utils.ErrorResponse(c, http.StatusBadRequest, "Invalid request body")
		return
	}

	device, err := h.service.UpdateDevice(c.Request.Context(), deviceID, &request)
	if err != nil {
		utils.ErrorResponse(c, http.StatusBadRequest, err.Error())
		return
	}
...
func (h *DeviceHandler) AssignOwner(c *gin.Context) {
	...
	var request model.AssignOwnerRequest
	if err := c.ShouldBindJSON(&request); err != nil {
		utils.ErrorResponse(c, http.StatusBadRequest, "Invalid request body")
		return
	}

	device, err := h.service.AssignOwner(c.Request.Context(), deviceID, &request)
	if err != nil {
		utils.ErrorResponse(c, http.StatusBadRequest, err.Error())
		return
	}
...
func (h *DeviceHandler) UnassignOwner(c *gin.Context) {
	...
	var request model.UnassignOwnerRequest
	if err := c.ShouldBindJSON(&request); err != nil {
		utils.ErrorResponse(c, http.StatusBadRequest, "Invalid request body")
		return
	}

	device, err := h.service.UnassignOwner(c.Request.Context(), deviceID, &request)
	if err != nil {
		utils.ErrorResponse(c, http.StatusBadRequest, err.Error())
		return
	}
...
func (h *DeviceHandler) UpdateStatus(c *gin.Context) {
	...
	device, err := h.service.UpdateStatus(c.Request.Context(), deviceID, &request)
	if err != nil {
		utils.ErrorResponse(c, http.StatusBadRequest, err.Error())
		return
	}
...
func (h *DeviceHandler) UpdateBattery(c *gin.Context) {
	...
	var request model.UpdateBatteryRequest
	if err := c.ShouldBindJSON(&request); err != nil {
		utils.ErrorResponse(c, http.StatusBadRequest, "Invalid request body")
		return
	}

	device, err := h.service.UpdateBattery(c.Request.Context(), deviceID, &request)
	if err != nil {
		utils.ErrorResponse(c, http.StatusBadRequest, err.Error())
		return
	}
...
func (h *DeviceHandler) BulkAssignOwner(c *gin.Context) {
	var request model.BulkAssignRequest
	if err := c.ShouldBindJSON(&request); err != nil {
		utils.ErrorResponse(c, http.StatusBadRequest, "Invalid request body")
		return
	}

	result, err := h.service.BulkAssignOwner(c.Request.Context(), &request)
	if err != nil {
		utils.ErrorResponse(c, http.StatusBadRequest, err.Error())
		return
	}
